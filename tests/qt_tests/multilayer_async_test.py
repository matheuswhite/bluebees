...
layer1 = ALayer1(producer, 'L1')
layer2 = ALayer2(layer1, 'L2')
consumer2 = ALayer3(layer2, 'C2')

tasks = [Task(consumer1.read_forever()), Task(consumer2.read())]
